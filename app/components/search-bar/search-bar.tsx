...
import { DEFAULT_DETAILS, DEFAULT_PAGE } from '../../../app/common/constant.js';

import { getParams, setParams } from '~/utils/params';
import { getSearchQuery, saveSearchQuery } from '~/services/storage';
import { SearchIcon } from '../icons/search-icon/search-icon.js';
import { ThemeToggle } from '../button-theme/button-theme.js';
